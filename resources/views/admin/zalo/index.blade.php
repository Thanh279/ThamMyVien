        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.zalo.update') }}" method="POST">
                            @csrf
                            @method('PUT')
                        ...
                        <div class="row text-center">
                            <div class="col-md-4">
                                <a href="{{ $zalo->zalo_url }}" target="_blank" class="btn btn-outline-primary btn-lg">
                                    <i class="fab fa-zalo fa-2x mb-2"></i><br>
                            ...
                            <div class="col-md-4">
                                <a href="{{ $zalo->messenger_url }}" target="_blank" class="btn btn-outline-info btn-lg">
                                    <i class="fab fa-facebook-messenger fa-2x mb-2"></i><br>
