                ...
                <div class="col-12 col-sm-4">
                    <div class="row m-hover">
                        @foreach($certificates as $index => $certificate)
                            <div class="col-12 col-sm-12  it-hover" data-img="{{ $certificate->image_path ? asset('storage/' . $certificate->image_path) : asset('images/home/h_image_sec3_4.png') }}" data-description="{{ $certificate->description ?? '' }}">
